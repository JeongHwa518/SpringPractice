...
<body>
	<form:form modelAttribute="user">		<!-- form태그 대신 form:form(스프링이 제공하는 form태그) 사용함, -->
	...
	<script type="text/javascript">
	    ...
	    */
		function setMessage(msg, element) {
			document.getElementById("msg").innerHTML = `<i class="fa fa-exclamation-circle" >${'${msg}'}</i>`;   //EL로 먼저 자바에서 해석한뒤, 자바스크립트단에서 EL 해석해야돼서 두번감쌈
			if (element) {
