...
class Car {
	...
	@Value("500") int oil;
	@Resource(name = "turborEngine") Engine engine;		// byType	- 타입으로 먼저 검색, 타입이 여러개면 이름으로 검색
...
public class SpringDITest {
	...
	public static void main(String[] args) {
		...
		Engine engine = (Engine)ac.getBean("turborEngine");		// byType, byName
